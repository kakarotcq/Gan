...
if not(os.path.exists('./tmp/')) or not os.listdir('./tmp/'):
  os.makedirs('./tmp/')
...
torch.save(netD.state_dict(),'Gnet_test.pth')
torch.save(netG.state_dict(),'Dnet_test.pth')
#print(netG.state_dict())
#print(netG.state_dict())

netG.load_state_dict(torch.load('Gnet_test.pth'))
netD.load_state_dict(torch.load('Dnet_test.pth'))
